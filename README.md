...
We maintain a collection of compiled binary showcases in the `examples/` directory. 

👉 [**Click here to see the Live Visual Gallery Dashboard**](docs/examples_preview.md) to inspect terminal animations of our binary workflows running in real-time.
...
2.  **Add the ftxmodel package.**
    ...
    CPMAddPackage(
      NAME ftxmodel
      GIT_REPOSITORY https://github.com/jplcz/ftxmodel.git
